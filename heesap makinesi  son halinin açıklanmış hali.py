...
#Hesap makinesinin çalışma biçimi şu şekilde:
#Köklü sayı, logaritma,üst alma(10 üzeride dahil) ve faktöriyel işlemleri için ilk önce sayıyı yazıp sonra 
#fonksiyona(kök,log, üst alma, faktöriyel ) basmak gerekiyor.Hesap makinesi ikiden fazla
